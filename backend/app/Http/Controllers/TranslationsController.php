...
class TranslationsController extends Controller
{
    ...
    {
        return response()->json(['texts' => OriginalTexts::select(['texts.id', 'languages.language_name as o_language_name', 'languages.language_code as o_language_code', 'translations.id as translation_id', 'translations.text', 'texts.text as original_text', 'translations.language_id'])
            ...
            })->leftJoin('languages', 'languages.id', '=', 'texts.language_id')->get()], 200);
    }
